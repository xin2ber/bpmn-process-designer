<template>
  <div class="panel-tab__content">
    <el-form size="mini" label-width="90px" @submit.native.prevent>
      ...
      <template v-if="type === 'ParallelMultiInstance' || loopCharacteristics === 'SequentialMultiInstance'">
...
export default {
  ...
  methods: {
    ...
    createElement(val) {
      const element = this.modeler.get('moddle').create('bpmn:Expression', { body: val })
      return element
    }
  }
};
