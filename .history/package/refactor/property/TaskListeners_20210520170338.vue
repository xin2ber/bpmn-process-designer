<template>
  <div class="panel-tab__content">
    ...
    <!-- 监听器 编辑/创建 部分 -->
    <el-drawer :visible.sync="showParamDialog" title="任务监听器" size="500px" append-to-body destroy-on-close>
      <listener-param  :showParamDialog="showParamDialog" :value="formData.taskListener[nowIndex].params" @close="finishConfigParam" />
    </el-drawer>
