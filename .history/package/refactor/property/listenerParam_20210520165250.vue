<template>
  <el-drawer :visible.sync="showParamDialog" title="任务监听器" size="600px" append-to-body destroy-on-close>
    <div class="panel-tab__content">
      <el-table :data="formData.paramList" size="mini" max-height="240" border fit>
    ...
    <template slot="footer">
        <el-button size="mini" @click="showParamDialog = false">取 消</el-button>
...
export default {
  ...
  methods: {
    add() {
      this.formData.paramList.splice(this.formData.paramList.length, 0, {});
    },
    remove(index) {
