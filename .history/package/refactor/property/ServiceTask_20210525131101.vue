  ...
  <div class="panel-tab__content">
    <el-form size="mini" label-width="90px" @submit.native.prevent>
      <el-form-item label="类型">
        <el-select  v-model="formData.implementationType" @change="changeType">
          <el-option v-for="i in Object.keys(implementationTypes)" :key="i" :label="implementationTypes[i]" :value="i" />
        </el-select>
      </el-form-item>
      <el-form-item :label="implementationTypes[formData.implementationType]">
