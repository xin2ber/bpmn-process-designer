    ...
    <el-collapse v-model="activeTab">
        <template v-for="(item, key) in showConfig.components">
          <el-collapse-item :key="key" v-if="element" :name="item">
            <div slot="title" class="panel-tab__title"><i :class="getComponentIcon(item)"></i><el-badge is-dot class="item" v-if="hasValue[item]" >{{getComponentName(item)}}</el-badge></div>
            <component
            :is="item"
            :element="element"
            :modeler="bpmnModeler"
